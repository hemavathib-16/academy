...
const generateMockResponse = (message) => {
  ...
  if (lowerMsg.match(/(course|find|looking for|prepare|preparation|exam|upsc|ca|jee|neet|kpsc)/)) {
    return "At BMS Academy, we offer top-tier coaching for UPSC, CA (Foundation, Inter, Final), IIT-JEE, NEET, and KPSC. Whether you need an integrated 2-year program or a crash course, we have you covered! What specific exam are you targeting?";
  }
