...
import certDistImg from "@/assets/cert_dist.jpg";
import lectureRoomImg from "@/assets/lecture_room.jpg";
import buildingImg from "@/assets/building.png";
import eventStageImg from "@/assets/event_stage.jpg";
import classroomTeachingImg from "@/assets/classroom_teaching.jpg";
import guestReceptionImg from "@/assets/guest_reception.jpg";
import studentGroupImg from "@/assets/student_group.jpg";

const galleryImages = [
  { src: buildingImg, title: "BMS Academic Block" },
  { src: studentGroupImg, title: "Student Celebrations & Events" },
  { src: classroomTeachingImg, title: "Classroom Teaching" },
  { src: lectureRoomImg, title: "Interactive Lecture Hall" },
  { src: certDistImg, title: "Student Achievement & Certification" },
  { src: eventStageImg, title: "Academy Events & Seminars" },
  { src: guestReceptionImg, title: "Guest Reception" },
      ...
      <section className="gradient-hero py-20 lg:py-28">
        <div className="container-custom text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            <span className="inline-block px-4 py-1.5 rounded-full bg-gold/20 text-gold text-sm font-semibold mb-4">Gallery</span>
            <h1 className="font-display text-4xl sm:text-5xl font-bold text-primary-foreground mb-4">Gallery</h1>
            <p className="text-lg text-primary-foreground/70 max-w-2xl mx-auto">A visual tour of our modern learning environment, events, and student life</p>
          </motion.div>
        </div>
      </section>
