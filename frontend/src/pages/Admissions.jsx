...
const Admissions = () => {
  ...
  const handleChange = (e) => {
    ...
    // Validate Date of Birth - year must be 4 digits
    ...
    // Limit phone numbers to 10 digits only
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-3xl mx-auto bg-card rounded-2xl p-8 sm:p-10 card-shadow border border-border/50 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <form onSubmit={handleSubmit} className="space-y-8 text-left">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground/70">📅 Year must contain exactly 4 digits (YYYY-MM-DD)</p>
                    </div>
                  </div>
                ...
                <div className="pt-4">
                  <button type="submit" disabled={isSubmitting} className="w-full py-4 bg-gold text-accent-foreground font-semibold rounded-xl hover:bg-gold-dark hover:scale-[1.01] transition-all gold-shadow flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100">
