            ...
            <div className="lg:col-span-3">
              <div className="bg-card rounded-xl p-6 lg:p-8 card-shadow border border-border/50">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button type="submit"
                    className="inline-flex items-center gap-2 px-8 py-3.5 bg-gold text-accent-foreground rounded-xl font-semibold hover:bg-gold-dark transition-colors gold-shadow">
